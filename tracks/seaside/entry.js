var trackFile = "./tracks/seaside/seasideharbour.glb"
var trackName = "Cool Castle Canyon"
var trackShadow = "./tracks/coolcastle/ShadowN3.png"
var startPos = new THREE.Vector3(180,50,180)
var startTheta = 0
var numLaps = 3
var floorName = ["Offroad","Road","RBridge","Docean"]
var wallName = []
var boosts = []
var materials = [];
...
loader.load(trackFile, function(gltf, err) {
  ...
  for (var i = 0; i < floorName.length; i++) {
    floor.push(root.getObjectByName(floorName[i]))
  }
...
function finalize(){
  water = scene.getObjectByName("Docean")
  swater = scene.getObjectByName("waterfall")
